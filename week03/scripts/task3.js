...
// when you use a function expression you need to add the function inside of a const variable
...
const substractNumber = function(){
    ...
    let substrahend = parseInt(document.querySelector("#subtrahend").value);
    let result = substract(minuend, substrahend);
...
//WOW I need to review this type of functions
